...
#make model iterable for example
...
class Post:
    ...
    # how to print out the text from the post.
    # need to add function that collates all the paragraph text together from the payload
    ...
    @detectedLanguage.setter
    def detectedLanguage(self, lang):
        self._detectedLanguage = lang
    ...
    def post_creatorId(self, creatorId):
        self._post_creatorId = creatorId
    
    @property
    def post_username(self):
        return self._post_username

    @post_username.setter
    def post_username(self, username):
        self._post_username = username
  
    @property
    def blockquote_list(self):
        return self._blockquote_list

    @blockquote_list.setter
    def blockquote_list(self, blockquotes):
        self._blockquote_list = blockquotes
    
    @property
    def tophighlight(self):
        return self._tophighlight

    @tophighlight.setter
    def tophighlight(self, tophighlighttext):
        self._tophighlight = tophighlighttext
        
    @property
    def existTophighlight(self):  #highlight may be found to exist but can't be extracted with current xpath
        return self._existTophighlight

    @existTophighlight.setter
    def existTophighlight(self, existTophighlightBool):
        self._existTophighlight = existTophighlightBool
    
    
    def getKeys():
        keys = ["post_id", "title", "post_date", "url", "recommend_count",
                "response_count", "read_time", "word_count", 
                "image_count", "preview_image", "detectedLanguage", 
                "post_content", "post_tags","post_creatorId", "post_username",
